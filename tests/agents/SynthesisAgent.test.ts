...
describe('SynthesisAgent', () => {
  ...
  describe('extractClaims', () => {
    ...
    it('should return empty array on LLM failure', async () => {
      ...
      const claims = await SynthesisAgent.extractClaims('Some content', 'https://example.com');
    ...
    it('should handle markdown code fences in response', async () => {
      ...
      const claims = await SynthesisAgent.extractClaims('Canon Toner', 'https://canon.com');
