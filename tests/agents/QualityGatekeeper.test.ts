...
describe('QualityGatekeeper', () => {
    ...
    it('should mark missing MPN as warning, not fatal error', async () => {
        const badData = {
            brand: 'HP',
            mpn_identity: { variant_flags: { chip: false, counterless: false, high_yield: false, kit: false } }, // Missing MPN
    ...
    it('should warn on missing logistics data', async () => {
        const partialData = {
            brand: 'HP',
            mpn_identity: { mpn: 'CF217A', variant_flags: { chip: false, counterless: false, high_yield: false, kit: false } },
            logistics: {}, // Empty
