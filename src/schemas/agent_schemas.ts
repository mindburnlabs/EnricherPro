    ...
    strategies: {
      ...
      items: {
        ...
        properties: {
          ...
          type: {
            type: 'string',
            enum: ['query', 'domain_crawl', 'firecrawl_agent', 'deep_crawl'],
          },
          queries: {
            type: 'array',
            items: { type: 'string' },
    ...
    new_tasks: {
      ...
      items: {
        ...
        properties: {
          type: {
            type: 'string',
            enum: ['query', 'enrichment', 'domain_crawl', 'firecrawl_agent'],
          },
          value: { type: 'string' },
          meta: {
            type: ['object', 'null'],
  ...
  properties: {
    ...
    mpn_identity: {
      ...
      properties: {
        ...
        authenticity: {
          type: ['string', 'null'],
          enum: ['oem', 'compatible', 'remanufactured', 'refill', 'fake', 'unknown', null],
        },
      },
      required: ['mpn', 'series'],
      additionalProperties: false,
    ...
    type_classification: {
      ...
      properties: {
        ...
        subtype: {
          type: 'string',
          enum: ['cartridge', 'bottle', 'unit', 'integrated_drum', 'separate_drum', 'unknown'],
        },
      },
    ...
    tech_specs: {
      ...
      properties: {
        ...
        chip_type: {
          type: ['string', 'null'],
          enum: ['oem', 'compatible', 'universal', 'none', 'unknown', null],
        },
      },
    ...
    compliance_ru: {
      ...
      properties: {
        ...
        mandatory_marking: {
          type: 'boolean',
          description: "Is 'Honest Sign' (Честный ЗНАК) required?",
        },
        certification_type: {
          type: ['string', 'null'],
          enum: ['mandatory', 'voluntary', 'refusal_letter', 'none', 'unknown', null],
        },
        has_sds: {
          type: 'boolean',
          description: 'Safety Data Sheet (Паспорт безопасности) available?',
        },
