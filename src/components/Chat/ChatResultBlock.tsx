                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-4">
                                <div className="bg-gray-50/80 dark:bg-gray-900/40 rounded-lg p-2 border border-gray-100 dark:border-gray-800/50">
                                    ...
                                    <div className="text-xs font-semibold text-gray-700 dark:text-gray-300 truncate">{item.data.brand || t('common.na', 'N/A')}</div>
                                </div>
                                <div className="bg-gray-50/80 dark:bg-gray-900/40 rounded-lg p-2 border border-gray-100 dark:border-gray-800/50">
                                    <div className="text-[10px] text-gray-400 uppercase font-bold tracking-wider mb-0.5">{t('specs.type', 'Type')}</div>
                                    <div className="text-xs font-semibold text-gray-700 dark:text-gray-300 truncate">{item.data.consumable_type || t('common.na', 'N/A')}</div>
                                </div>
                            </div>
                            ...
                            <div className="mt-auto flex flex-col sm:flex-row items-stretch sm:items-center gap-2 pt-4 border-t border-gray-100 dark:border-gray-800/50">
                                ...
                                <button
                                    ...
                                    className={`px-3 py-2 text-xs font-bold rounded-xl transition-all shadow-sm active:scale-95 flex items-center justify-center gap-2 flex-[1.5] ${item.status === 'published'
