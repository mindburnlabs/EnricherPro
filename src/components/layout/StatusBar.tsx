    ...
    return (
        <div className="h-8 bg-surface border-t border-border-subtle flex items-center justify-between px-4 text-[10px] text-primary-subtle select-none">
            ...
            <div className="flex items-center gap-4 font-mono">
                <span className="flex items-center gap-1 hover:text-primary transition-colors cursor-help" title="Tokens used in current session">
                    <Activity size={12} />
                    12.5k / 50k
                </span>
                <span className="flex items-center gap-1 hover:text-primary transition-colors cursor-help" title="Estimated cost">
                    <DollarSign size={12} />
                    0.023
                </span>
            </div>
