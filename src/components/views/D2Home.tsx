    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-4 min-h-full relative overflow-hidden">
            ...
            <div className="w-full max-w-2xl z-10 flex flex-col items-center gap-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
                ...
                <div className={`w-full relative transition-all duration-300 ${isFocused ? 'scale-105' : 'scale-100'}`}>
                    <form onSubmit={handleSubmit} className="relative group">
                        ...
                        <div className="relative bg-surface border border-border-subtle rounded-xl shadow-2xl flex items-center p-2 transition-colors focus-within:border-border-highlight focus-within:ring-1 focus-within:ring-primary-accent/50">
                            ...
                            <input
                                ...
                                placeholder={t('home.placeholder', 'Enter a supplier string (e.g. "HP 26X Toner")...')}
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 w-full opacity-0 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300 fill-mode-forwards" style={{ animationFillMode: 'forwards' }}>
                    <div className="p-3 rounded-lg border border-border-subtle bg-surface/50 hover:bg-surface hover:border-primary-accent/30 transition cursor-pointer flex flex-col items-center text-center gap-2 group">
                        ...
                        <span className="text-xs font-medium text-primary-subtle group-hover:text-primary">Global Sources</span>
                    </div>
                     <div className="p-3 rounded-lg border border-border-subtle bg-surface/50 hover:bg-surface hover:border-primary-accent/30 transition cursor-pointer flex flex-col items-center text-center gap-2 group">
                        <div className="p-2 rounded-full bg-primary-subtle/10 group-hover:bg-primary-accent/10 transition text-primary-accent">
                           <Zap size={16} /> 
                        </div>
                        <span className="text-xs font-medium text-primary-subtle group-hover:text-primary">Real-Time</span>
                    </div>
                     <div className="p-3 rounded-lg border border-border-subtle bg-surface/50 hover:bg-surface hover:border-primary-accent/30 transition cursor-pointer flex flex-col items-center text-center gap-2 group">
                        <div className="p-2 rounded-full bg-primary-subtle/10 group-hover:bg-primary-accent/10 transition text-primary-accent">
                           <FileText size={16} /> 
                        </div>
                        <span className="text-xs font-medium text-primary-subtle group-hover:text-primary">PDF Mining</span>
                    </div>
                     <div className="p-3 rounded-lg border border-border-subtle bg-surface/50 hover:bg-surface hover:border-primary-accent/30 transition cursor-pointer flex flex-col items-center text-center gap-2 group">
                        <div className="p-2 rounded-full bg-primary-subtle/10 group-hover:bg-primary-accent/10 transition text-primary-accent">
                           <Sparkles size={16} /> 
                        </div>
                        <span className="text-xs font-medium text-primary-subtle group-hover:text-primary">Auto-Resolve</span>
                    </div>
                </div>
