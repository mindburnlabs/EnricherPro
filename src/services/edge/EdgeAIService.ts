...
export class EdgeAIService {
    ...
    private static readonly DEFAULT_MODEL_URL = 'https://huggingface.co/Xenova/all-MiniLM-L6-v2/resolve/main/onnx/model_quantized.onnx';
     ...
     */
    private static simpleTokenize(text: string): { input_ids: BigInt64Array; attention_mask: BigInt64Array } {
    ...
    static async embed(text: string, useCache = true): Promise<EmbeddingResult> {
        ...
        try {
            ...
            const attentionMaskTensor = new this.ort.Tensor('int64', attention_mask, [1, this.TOKEN_MAX_LENGTH]);
