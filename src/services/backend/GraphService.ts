...
export class GraphService {
     ...
     */
    static async resolveIdentity(query: string, brand?: string): Promise<{ mpn: string, confidence: number, entityId: string } | null> {
     ...
     */
    static async linkAlias(alias: string, mpn: string, brand: string, source: string = 'inference'): Promise<void> {
        try {
     ...
     */
    static async linkCompatibility(mpn: string, printer: string, source: string = 'inference'): Promise<void> {
