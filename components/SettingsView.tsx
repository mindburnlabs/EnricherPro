...
import { Shield, Key, Save, AlertCircle, CheckCircle2, Loader2, XCircle, Activity, TrendingUp, Settings as SettingsIcon, Zap, Brain } from 'lucide-react';
...
const SettingsView: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'api-keys' | 'monitoring'>('api-keys');
  ...
  const handleOpenRouterSave = async () => {
    ...
    try {
      ...
      await service.getAvailableModels(); // This will validate the API key
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-5 py-4 bg-slate-50 border-2 rounded-2xl focus:bg-white focus:outline-none font-mono text-sm transition-all ${
                        openRouterStatus === 'error' ? 'border-rose-200 focus:border-rose-500' : 'border-slate-50 focus:border-purple-500'
                      }`}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-5 py-4 bg-slate-50 border-2 border-slate-50 rounded-2xl focus:bg-white focus:outline-none focus:border-purple-500 text-sm transition-all"
                    >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                  <div className="text-center">
                    <div className={`text-2xl font-black mb-1 ${
                      systemHealth.overallHealth === 'healthy' ? 'text-green-600' :
                  ...
                  <div className="text-center">
                    <div className={`text-2xl font-black mb-1 ${
                      systemHealth.criticalAlerts > 0 ? 'text-red-600' : 'text-green-600'
                    }`}>
